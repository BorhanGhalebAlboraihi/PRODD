...
@Component({
  selector: 'app-sales-yields',
  templateUrl: './sales-yields.component.html',
  styleUrls: ['./sales-yields.component.css']
})
export class SalesYieldsComponent implements OnInit {
