...
@Component({
  selector: 'app-yield-lastyears',
  templateUrl: './yield-lastyears.component.html',
  styleUrls: ['./yield-lastyears.component.css']
})
export class YieldLastyearsComponent implements OnInit {
