...
@Component({
  selector: 'app-instant-buying-bills',
  templateUrl: './instant-buying-bills.component.html',
  styleUrls: ['./instant-buying-bills.component.css']
})
export class InstantBuyingBillsComponent implements OnInit {
