...
@Component({
  selector: 'app-cost-local-buyers',
  templateUrl: './cost-local-buyers.component.html',
  styleUrls: ['./cost-local-buyers.component.css']
})
export class CostLocalBuyersComponent implements OnInit {
