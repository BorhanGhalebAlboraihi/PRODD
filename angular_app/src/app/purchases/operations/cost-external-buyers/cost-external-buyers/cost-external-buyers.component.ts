...
@Component({
  selector: 'app-cost-external-buyers',
  templateUrl: './cost-external-buyers.component.html',
  styleUrls: ['./cost-external-buyers.component.css']
})
export class CostExternalBuyersComponent implements OnInit {
