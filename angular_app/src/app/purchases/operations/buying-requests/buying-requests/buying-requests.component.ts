...
@Component({
  selector: 'app-buying-requests',
  templateUrl: './buying-requests.component.html',
  styleUrls: ['./buying-requests.component.css']
})
export class BuyingRequestsComponent implements OnInit {
