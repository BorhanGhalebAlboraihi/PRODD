...
@Component({
  selector: 'app-order-supply',
  templateUrl: './order-supply.component.html',
  styleUrls: ['./order-supply.component.css']
})
export class OrderSupplyComponent implements OnInit {
