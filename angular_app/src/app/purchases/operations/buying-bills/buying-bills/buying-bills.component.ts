...
@Component({
  selector: 'app-buying-bills',
  templateUrl: './buying-bills.component.html',
  styleUrls: ['./buying-bills.component.css']
})
export class BuyingBillsComponent implements OnInit {
