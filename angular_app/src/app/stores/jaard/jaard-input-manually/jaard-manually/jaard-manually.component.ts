...
@Component({
  selector: 'app-jaard-manually',
  templateUrl: './jaard-manually.component.html',
  styleUrls: ['./jaard-manually.component.css']
})
export class JaardManuallyComponent implements OnInit {
