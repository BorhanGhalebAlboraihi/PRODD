...
@Component({
  selector: 'app-displaying-stores',
  templateUrl: './displaying-stores.component.html',
  styleUrls: ['./displaying-stores.component.css']
})
export class DisplayingStoresComponent implements OnInit {
