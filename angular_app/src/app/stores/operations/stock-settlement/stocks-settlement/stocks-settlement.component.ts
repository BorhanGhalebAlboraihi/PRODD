...
@Component({
  selector: 'app-stocks-settlement',
  templateUrl: './stocks-settlement.component.html',
  styleUrls: ['./stocks-settlement.component.css']
})
export class StocksSettlementComponent implements OnInit {
