...
@Component({
  selector: 'app-supply-stores',
  templateUrl: './supply-stores.component.html',
  styleUrls: ['./supply-stores.component.css']
})
export class SupplyStoresComponent implements OnInit {
