...
import { CreateChartOfAccountsDialogComponent } from './Accounts/Input-bases/ChartOfAccounts/create-chartOfAccounts/create-chartOfAccounts-dialog.component';
import { EditChartOfAccountsDialogComponent } from './Accounts/Input-bases/ChartOfAccounts/edit-chartOfAccounts/edit-chartOfAccounts-dialog.component';
import { CostCenterssComponent } from './Accounts/Input-bases/CostCenters/costCenters.component';
import { EditcostCentersDialogComponent} from './Accounts/Input-bases/CostCenters/edit-costCenters/edit-costCenters-dialog.component';
import {  CreatecostCentersDialogComponent } from './Accounts/Input-bases/CostCenters/create-costCenters/create-costCenters-dialog.component';
...
@NgModule({
  declarations: [
    ...
    ChartOfAccountssComponent,
    CreateChartOfAccountsDialogComponent,
    EditChartOfAccountsDialogComponent,
    CostCenterssComponent ,
    EditcostCentersDialogComponent,
    CreatecostCentersDialogComponent
