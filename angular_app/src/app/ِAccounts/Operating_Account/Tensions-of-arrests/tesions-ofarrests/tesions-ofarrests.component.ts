...
@Component({
  selector: 'app-tesions-ofarrests',
  templateUrl: './tesions-ofarrests.component.html',
  styleUrls: ['./tesions-ofarrests.component.css']
})
export class TesionsOfarrestsComponent implements OnInit {
