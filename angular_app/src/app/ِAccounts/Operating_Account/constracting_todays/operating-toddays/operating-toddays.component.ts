...
@Component({
  selector: 'app-operating-toddays',
  templateUrl: './operating-toddays.component.html',
  styleUrls: ['./operating-toddays.component.css']
})
export class OperatingToddaysComponent implements OnInit {
