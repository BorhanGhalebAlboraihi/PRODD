...
@Component({
  selector: 'app-daily-extchange',
  templateUrl: './daily-extchange.component.html',
  styleUrls: ['./daily-extchange.component.css']
})
export class DailyExtchangeComponent implements OnInit {
