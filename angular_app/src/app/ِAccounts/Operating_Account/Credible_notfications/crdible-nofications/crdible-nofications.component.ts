...
@Component({
  selector: 'app-crdible-nofications',
  templateUrl: './crdible-nofications.component.html',
  styleUrls: ['./crdible-nofications.component.css']
})
export class CrdibleNoficationsComponent implements OnInit {
