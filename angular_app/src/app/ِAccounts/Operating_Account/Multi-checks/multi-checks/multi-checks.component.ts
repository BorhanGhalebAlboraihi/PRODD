...
@Component({
  selector: 'app-multi-checks',
  templateUrl: './multi-checks.component.html',
  styleUrls: ['./multi-checks.component.css']
})
export class MultiChecksComponent implements OnInit {
