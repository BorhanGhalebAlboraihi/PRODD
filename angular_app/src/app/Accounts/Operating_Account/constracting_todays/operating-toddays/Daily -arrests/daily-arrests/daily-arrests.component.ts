...
@Component({
  selector: 'app-daily-arrests',
  templateUrl: './daily-arrests.component.html',
  styleUrls: ['./daily-arrests.component.css']
})
export class DailyArrestsComponent implements OnInit {
