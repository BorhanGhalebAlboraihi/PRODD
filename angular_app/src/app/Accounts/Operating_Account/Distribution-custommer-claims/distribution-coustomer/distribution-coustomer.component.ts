...
@Component({
  selector: 'app-distribution-coustomer',
  templateUrl: './distribution-coustomer.component.html',
  styleUrls: ['./distribution-coustomer.component.css']
})
export class DistributionCoustomerComponent implements OnInit {
