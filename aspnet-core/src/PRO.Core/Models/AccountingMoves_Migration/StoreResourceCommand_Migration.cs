...
{
    public class StoreResourceCommand_Migration
    {
        //ترحيل اوامر التوريد و المردود المخزني
        [Key]
        public int Move_Id { get; set; }
        public DateTime MigrationHistory { get; set; }
        /// <summary>
        /// تختار هل امر توريد ام امر مردود
        /// </summary>
        ...
        /// </summary>
        public bool Resource_Command { get; set; }
        public bool ReturnsCommand { get; set; }
        /// <summary>
